...
const app = express();
const PORT = 3001; // Use port 3001 to avoid conflict
...
app.post('/api/predict', upload.single('image'), (req, res) => {
  try {
    ...
    // Simulate realistic disease detection based on filename
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Plant Disease Backend running on port ${PORT}`);
